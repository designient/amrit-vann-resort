export function StructuredData() {
  const hotelSchema = {
    ...
    description:
      "A luxury jungle retreat near Pench Tiger Reserve in Khawasa, Madhya Pradesh. Wildlife safaris, world-class dining, spa, and serene jungle accommodations.",
    url: "https://amritvannresort.com",
    image: "https://amritvannresort.com/images/og-image.jpg",
    address: {
      "@type": "PostalAddress",
      streetAddress: "Pench National Park, Turia, Awarghani-Turia Road",
      addressLocality: "Khawasa",
